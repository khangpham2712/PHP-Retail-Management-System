...
const CustomerStatistics = () => {
  ...
  return (
    ...
    {/* <ReportCard  title={`Top ${limit}  theo ${getTitle()}`}  */}
    <ReportCard 
      typeTitle={getTitle()}
      limitTitle={`Top ${limit} khách hàng `}
      ToolBar={
        <>
...
const title = [" số lần mua", " tổng tiền mua"," lợi nhuận" ]
            ...
            >
              ...
              <Grid item xs={2}>
                <Typography style={{ fontSize: 16, textAlign: "center" }}>
                  {item.count_buy ? Number(item.count_buy).toLocaleString() : 0}
                </Typography>
              </Grid>
              <Grid item xs={2}>
                <Typography style={{ fontSize: 16, textAlign: "center" }}>
                  {item.total_buy_price
                    ? Number(item.total_buy_price).toLocaleString()
                    : 0}
                </Typography>
              </Grid>
            </Grid>
